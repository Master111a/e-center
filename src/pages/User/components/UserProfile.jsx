...
import { ProfileCourse, ProfileIntro } from "./Profile";
import { useDispatch, useSelector } from "react-redux";
import { updateUserAPI } from "../../../services/user.api";
import { updateUser, updateUserList } from "../../../redux/slice/user.slice";
    ...
    <main className="relative container mx-auto p-0 my-0 flex min-h-[100vh]">
      <section className="relative pt-0 px-4 md:pt-2 lg:px-0 flex flex-col flex-1 w-full max-w-full">
        ...
        <div className="mt-[90px] px-6">
          <section className="flex flex-wrap -mx-1 md:-mx-2 lg:-mx-3 max-h-[400px] overflow-hidden">
            <ProfileIntro />
            {user?.role === 3 && <ProfileCourse />}
          </section>
        </div>
      </section>
    </main>
